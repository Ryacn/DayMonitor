...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "daymonitor.db";
    ...
    public static final String R_COL_4 = "SWITCH_STATE";
    public static final String R_COL_5 = "START_TIME";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table " + R_TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME TEXT, CATEGORY TEXT, SWITCH_STATE BOOLEAN DEFAULT 0, START_TIME INTEGER)");
    ...
    public boolean updateData(long id, String name, String cat, boolean switchState, long time){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        //contentValues.put(R_COL_1, id);
        //contentValues.put(R_COL_2, name);
        //contentValues.put(R_COL_3, cat);
        contentValues.put(R_COL_4, switchState);
        contentValues.put(R_COL_5, time);
